...
│   ├── software_installation/		   # Guide on what software to use and install on the Raspberry Pi
...
6. Optional, a short [male micro-USB to female USB-A connector](https://www.adafruit.com/product/1099). This is good for when you want to eliminate the USB hub and just plug in the Wi-Fi adaptor.
...
1. [Raspbian OS Installation](/data_ferry/system_install/README.md) <-- Start here
